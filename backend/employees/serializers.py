...
class EmployeeSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'is_active', 'employee_id', 'department', 'department_name', 'phone'
        ]
        read_only_fields = ('id', 'joining_date', 'user', 'company', 'company_name', 'employee_id', 'department_name', 'phone')
...
class EmployeeDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        read_only_fields = ('id', 'joining_date', 'user', 'employee_id', 'department_name', 'phone') 